    ...
    return (
        <div className='flex justify-start gap-5 p-2 text-gray-500'>
            ...
            {session?.user?.uid === uid && (
                <HiOutlineTrash className='h-8 w-8 cursor-pointer rounded-full transition duration-500 ease-in-out p-2 hover:text-red-500 hover:bg-red-100' onClick={deletePost} />
            )}
        </div>
    )
}
